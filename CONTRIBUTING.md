...
Thank you for your interest in improving Cookiecutter Django Package.
...
```console
$ cookiecutter path/to/cookiecutter-django-package
```
...
of the form `YYYY.MM.RR`. Year, Month, Release.
